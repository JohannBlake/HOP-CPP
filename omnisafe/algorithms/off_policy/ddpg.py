...
class DDPG(BaseAlgo):
    ...
    def _init_log(self) -> None:
        ...
        self._logger.register_key('Metrics/EpRet', window_length=1)
        self._logger.register_key('Metrics/EpCost', window_length=1)
        self._logger.register_key('Metrics/EpLen', window_length=1)
        
        # Register custom environment metrics
        self._logger.register_key('Metrics/GoalCoverage', window_length=1)
        self._logger.register_key('Metrics/AvgStepRet', window_length=1)
        self._logger.register_key('Metrics/EpCollisions', window_length=1)

        if self._cfgs.train_cfgs.eval_episodes > 0:
            self._logger.register_key('Metrics/TestEpRet', window_length=4)
            self._logger.register_key('Metrics/TestEpCost', window_length=4)
            self._logger.register_key('Metrics/TestEpLen', window_length=4)
