...
class PETS(BaseAlgo):
    ...
    def _init_log(self) -> None:
        ...
        if self._cfgs.evaluation_cfgs.use_eval:
            self._logger.register_key('EvalMetrics/EpRet', window_length=4)
            self._logger.register_key('EvalMetrics/EpCost', window_length=4)
            self._logger.register_key('EvalMetrics/EpLen', window_length=4)
