...
class CriticBuilder:
    ...
    def build_critic(
        ...
        """
        if critic_type == 'cnn_q':
            from omnisafe.models.critic.cnn_q_critic import CNNQCritic
            return CNNQCritic(
        ...
        if critic_type == 'fused_q':
            from omnisafe.models.critic.fused_q_critic import FusedQCritic
            return FusedQCritic(
                obs_space=self._obs_space,
                act_space=self._act_space,
                hidden_sizes=self._hidden_sizes,
        ...
        raise NotImplementedError(
            ...
            'Available critic types are: "cnn_q", "fused_q", "q", "v".',
        )
